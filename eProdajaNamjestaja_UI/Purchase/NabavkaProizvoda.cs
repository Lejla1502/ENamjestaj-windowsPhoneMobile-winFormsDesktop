        ...
        NabavkaProizvoda : Form
    {
            ...
            if (this.ValidateChildren())
            {
                ...
                if (dtProizvodi.DataSource != null)
                {
                    ...
                    for (int i=0;i<lista.Count();i++)
                    {
                        ...
                        //ulaz.IznosRacuna += Convert.ToDecimal(txtCijena.Text) * Convert.ToInt32(txtKolicina.Text);
                        //ulaz.PDV = (Convert.ToDecimal(ulaz.IznosRacuna) * 17 / 100);
                        //txtIznos.Text = (Convert.ToInt32(txtCijena.Text) * Convert.ToInt32(txtKolicina.Text)).ToString();
                        //txtPDV.Text = Convert.ToString(Convert.ToDecimal(ulaz.IznosRacuna) * 17 / 100);
                        //ulaz.Napomena = txtNapomena.Text;
        ...
        private void btnDodajProizvod_Click(object sender, EventArgs e)
        {
           ...
           /* if (cmx_proizvodi.SelectedIndex == 0 || string.IsNullOrEmpty(txtKolicina.Text)
                || !txtCijena.MaskFull || string.IsNullOrEmpty(txtSifra.Text))
                MessageBox.Show("Popunite odgovarajuca polja");
            else
            {
                ...
                {
                    MessageBox.Show(cmx_proizvodi.SelectedValue.ToString());
                    ...
                    if (proizvodId != 0)
                    {
                        ...
                        p.Cijena1 = Convert.ToDecimal(txtCijena.Text);
                        //p.Sifra = txtSifra.Text;
        ...
        /*if (this.ValidateChildren())
        {
            ...
            p.Kolicina1 = Convert.ToInt32(txtKolicina.Text);
            p.Cijena1 = Convert.ToDecimal(txtCijena.Text);
            p.SifraProizvoda = txtSifra.Text;
            p.ProizvodID = proizvodId;
            dtProizvodi.DataSource = null;
            lista.Add(p);
            dtProizvodi.DataSource = lista;
      ...
      (e.KeyChar != '.'))
       ...
       // private void txtCijena_KeyPress_1(object sender, KeyPressEventArgs e)
       // {
       //     if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) &&
       //(e.KeyChar != '.'))
       //     {
